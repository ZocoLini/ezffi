...
int main() {
  ...
  const FfiCar *carC = ffi__ffi_car_new();
  ...
  const FfiDeallocationStruct *obj = ffi__ffi_deallocation_struct_new();
  const FfiDeallocationStruct *clone1 = ffi__ffi_deallocation_struct_manual_clone(obj);
  const FfiDeallocationStruct *clone2 = ffi__ffi_deallocation_struct_manual_clone(obj);
